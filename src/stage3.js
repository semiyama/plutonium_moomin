class Stage3 extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image('bg03', 'assets/bg_03.png');
        ...
        this.load.image('dialog_stage3_1', 'assets/dialog/stage3_1.png');
        this.load.image('dialog_stage3_2', 'assets/dialog/stage3_2.png');        
        this.load.image('mii', 'assets/mii.png');
        ...
        this.load.audio('minzoku', 'bgm/minzoku.mp3');
    ...
    create() {
        ...
        //bgm
        var music = this.sound.add('minzoku', { volume: 0.2, loop: true });
        music.play();
        ...
        this.stopTimer = this.time.addEvent({
            delay: 1000,
            callback: function() {
                this.dialog_stage3_1 = new Dialog(
                    this,
                ...
                this.dialogs.add(this.dialog_stage3_1);
            },
            callbackScope: this,
            loop: false
        });
        ...
        this.stopTimer = this.time.addEvent({
            delay: 9000,
            callback: function() {
                this.dialog_stage3_2 = new Dialog(
                    this,
                    game.config.width * 0.5,
                    -200,
                    "dialog_stage3_2",
                ...
                this.dialogs.add(this.dialog_stage3_2);
            },
            callbackScope: this,
            loop: false
        });        
        ...
        //background
        var bg = new ScrollingBackground(this, 'bg03', 10);
