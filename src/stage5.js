class Stage5 extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image('bg05', 'assets/bg_05.png');
        this.load.spritesheet('moomin', 'assets/moomin.png', { frameWidth: 134, frameHeight: 214 });
        this.load.spritesheet('enemy_weapon_blue', 'assets/weapon_enemy_blue.png', { frameWidth: 80, frameHeight: 80 });   
        this.load.spritesheet('inferno', 'assets/inferno.png', { frameWidth: 140, frameHeight: 200 });                 
        this.load.image('weapon', 'assets/weapon.png');
        this.load.image('dialog_stage5_1', 'assets/dialog/stage5_1.png');
        this.load.image('dialog_stage5_2', 'assets/dialog/stage5_2.png');
        this.load.image('dialog_stage5_3', 'assets/dialog/stage5_3.png');
        this.load.image('dialog_stage5_4', 'assets/dialog/stage5_4.png');        
        this.load.image('froren', 'assets/froren.png');
        ...
        this.load.audio('waltz', 'bgm/waltz.mp3');
    ...
    create() {
        ...
        //bgm
        var music = this.sound.add('waltz', { volume: 1, loop: true });
        music.play();

        //animation
        this.anims.create({
            key: "enemy_weapon_blue",
            frames: this.anims.generateFrameNumbers("enemy_weapon_blue"),
            frameRate: 20,
            repeat: -1
        });
        this.anims.create({
            key: "inferno",
            frames: this.anims.generateFrameNumbers("inferno"),
            frameRate: 20,
            repeat: -1
        });
        this.anims.create({
        ...
        this.dialog_stage5_1= new Dialog(
            this,
        ...
        this.dialogs.add(this.dialog_stage5_1);

        this.stopTimer = this.time.addEvent({
            delay: 8000,
            callback: function() {
                this.dialog_stage5_2 = new Dialog(
                    this,
                    game.config.width * 0.5,
                    -200,
                    "dialog_stage5_2",
                ...
                this.dialogs.add(this.dialog_stage5_2);
            },
            callbackScope: this,
            loop: false
        });
        ...
        this.stopTimer = this.time.addEvent({
            delay: 16000,
            callback: function() {
                this.dialog_stage5_3 = new Dialog(
                    this,
                    game.config.width * 0.5,
                    -200,
                    "dialog_stage5_3",
                ...
                this.dialogs.add(this.dialog_stage5_3);
            },
            callbackScope: this,
            loop: false
        });
        ...
        this.stopTimer = this.time.addEvent({
            delay: 23000,
            callback: function() {
                this.dialog_stage5_4 = new Dialog(
                    this,
                    game.config.width * 0.5,
                    -200,
                    "dialog_stage5_4",
                ...
                this.dialogs.add(this.dialog_stage5_4);
            },
            callbackScope: this,
            loop: false
        });        
        ...
        //background
        var bg = new ScrollingBackground(this, 'bg05', 10);
